...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Run SIFT Algorithm (Performance)"))
        ...
        self.pushButton.setText(_translate("MainWindow", "Run SIFT Algorithm (Research)"))
