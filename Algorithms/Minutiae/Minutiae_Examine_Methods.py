...
display_image(img_enhanced_train,title="At Image Enhancement Side")
...
from Algorithms.Minutiae.Libs.minutiae import *
...
# Corner Detection Harris Side
# Edges - Harris - matching libs
import cv2
import matplotlib.pyplot as plt

from Algorithms.Minutiae.Libs.edges import *
